...
private val LightColorScheme = lightColorScheme(
    ...
    tertiaryContainer = TertiaryPlumContainer,
    onTertiaryContainer = OnTertiaryPlumContainer,
...
fun MyApplicationTheme(
    ...
    // Dynamic color is available on Android 12+ (disable to enforce our high-fidelity brand theme)
